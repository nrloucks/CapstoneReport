...
\begin{document}
	...
	\par We would like to express our gratitude to Mario Bkassiny, for his constant support and guidance. Our sincere thanks goes to Dennis Quill for all his help with parts as well as his expertise on working with Raspberry Pi. 
	\par Finally we would like to thank the ECE department as a whole for providing the resources necessary to make this research possible despite having to work completely remotely due to the unique circumstances of the spring 2020 semester. Without the planning and preparation made by the ECE department none of this would have been possible. 
